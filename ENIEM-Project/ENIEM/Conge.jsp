...
<title>Congé</title>
<script language="Javascript" src="JavaScript/formConge.js"></script>
</head>
<body>
	...
	<div style="position:absolute;top:173px;left:430px;">
		<p style="color:grey;background-color:#DAE6E7;border:#C5DCE4 solid 3px;padding:2px 2px 2px 2px;font-family:Arial;font-size:24px;"><b>Ajouter un congé</b></p>
	</div>
	
	<div class="cadre" style="margin-left:400px; margin-top:110px;width:500px;height:240px;">
	<form name="FormulaireConge" action="FormCng.do" method="post" onSubmit="return verifformcng()">
		<table>
		<% 
			...
			<tr>
				<td class="td">Désignation du congé : </td>
				<td class="td2"><input class="moz" type="text" name="des_cng" size="30" maxlength=25/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Année du congé : </td>
				<td class="td2"><select class="choix" name="annee_cng">
			...
			<tr>
				...
				<td class="td2"><select class="choix" name="jour_deb_cng">
								<option selected></option>
					...
					<select class="choix" name="mois_deb_cng">
								<option selected></option>
					...
					<select class="choix" name="annee_deb_cng">
						<option selected></option>
						<%for(int i=1930; i<=2060; i++){ %>
							<option value="<%=i %>"><%=i %></option>
						<%} %>			
			...
			<tr>
				...
				<td class="td2"><select class="choix" name="jour_fin_cng">
								<option selected></option>
								<option value="01">01</option>
								<option value="02">02</option>
								<option value="03">03</option>
					...
					<select class="choix" name="mois_fin_cng">
								<option selected></option>
								<option value="Janvier">Janvier</option>
								<option value="Février">Février</option>
								<option value="Mars">Mars</option>
					...
					<select class="choix" name="annee_fin_cng">
						<option selected></option>
						<%for(int i=1930; i<=2060; i++){ %>
							<option value="<%=i %>"><%=i %></option>
						<%} %>			
