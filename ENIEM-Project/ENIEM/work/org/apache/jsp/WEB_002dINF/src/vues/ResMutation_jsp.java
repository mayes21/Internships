...
public final class ResMutation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Mutation ajoutée avec succès</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tCette mutation a été ajoutée avec succès<span style=\"color:#C6E4BE;\">_____</span> <img src=\"Images/succes.png\" alt=\"succ\">\r\n");
      out.write("\t\t\t<br/>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t<span style=\"color:blue;\">Nouveau poste :</span>");
      out.print( request.getParameter("nouv_post").toString());
      out.write("<br/><br/>\r\n");
      out.write("\t\t\t<span style=\"color:blue;\">Nouveau département :</span>");
      out.print( request.getParameter("nouv_dept").toString());
      out.write("<br/><br/>\r\n");
      out.write("\t\t\t<span style=\"color:blue;\">Raison de la mutation :</span>");
      out.print( request.getParameter("rai_mut").toString());
      out.write("<br/><br/>\r\n");
      out.write("\t\t\t<span style=\"color:blue;\">Date de la mutation :</span>");
      out.print( request.getParameter("jour_mut").toString());
      out.write('-');
      out.print( request.getParameter("mois_mut").toString());
      out.write('-');
      out.print( request.getParameter("annee_mut").toString());
      out.write("<br/><br/>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div style=\"position:absolute; top:560px; left:1080px;\">\r\n");
      out.write("\t\t\t<a href=\"MUTATION\" title=\"Retour au formulaire d'ajout de promotion\"><img src=\"Images/bouton-retour-accueil.png\" alt=\"bouton-retour-accueil\"></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
