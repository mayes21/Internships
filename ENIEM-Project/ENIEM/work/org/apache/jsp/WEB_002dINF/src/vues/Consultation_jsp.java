...
public final class Consultation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \t\t\t\t<li class=\"ong\" id=\"actif\"><span><b>Consultation</b></span></li>\r\n");
      out.write("  \t\t\t\t<li class=\"ong\"><a href=\"CONFIGURATION\"><span><b>Configuration</b></span></a></li>\r\n");
      out.write("  \t\t\t\t<li class=\"ong\"><a href=\"deconnexionadm.do\"><span><b>Déconnexion</b></span></a></li>\r\n");
      out.write(" \t\t\t</ul>\r\n");
      out.write(" \t\t </div>\r\n");
      out.write("\t</div>\t\t\r\n");
      out.write("<CENTER>\r\n");
      out.write("\t<div style=\"margin-top:40px;width:82%;\">\r\n");
      out.write("\t\r\n");
      out.write("\t");
    ...
    out.println("<center><form name=\"formulaireModif\" action=\"detailsEmp.jsp\" method=\"post\" onSubmit=\"return verifAcc()\">");
    ...
    rs.close();
                    ...
                    out.println("</tbody>");
                    out.println("</table>");
                    out.println("<input type=\"submit\" name=\"consultation+\" value=\"Plus de détails\"/>");
                    out.println("</center");
                    out.println("</form>");
