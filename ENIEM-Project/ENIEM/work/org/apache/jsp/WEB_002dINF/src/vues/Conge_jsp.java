...
public final class Conge_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Congé</title>\r\n");
      out.write("<script language=\"Javascript\" src=\"JavaScript/formConge.js\"></script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t<p style=\"color:grey;background-color:#DAE6E7;border:#C5DCE4 solid 3px;padding:2px 2px 2px 2px;font-family:Arial;font-size:24px;\"><b>Ajouter un congé</b></p>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"cadre\" style=\"margin-left:400px; margin-top:110px;width:500px;height:240px;\">\r\n");
      out.write("\t<form name=\"FormulaireConge\" action=\"resConge.do\" method=\"post\" onSubmit=\"return verifformcng()\">\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"td\">Désignation du congé : </td>\r\n");
      out.write("\t\t\t\t<td class=\"td2\"><input class=\"moz\" type=\"text\" name=\"des_cng\" size=\"30\" maxlength=25/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr></tr><tr></tr><tr></tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"td\">Année du congé : </td>\r\n");
      out.write("\t\t\t\t<td class=\"td2\"><select class=\"choix\" name=\"année_cng\">\r\n");
...
for(int i=1930; i<=2060; i++){ 
      ...
      out.write("\t\t\t\t<td class=\"td2\"><select class=\"choix\" name=\"jour_deb_cng\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option selected></option>\r\n");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"mois_deb_cng\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option selected></option>\r\n");
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"année_deb_cng\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
for(int i=1930; i<=2060; i++){ 
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<td class=\"td2\"><select class=\"choix\" name=\"jour_fin_cng\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"01\">01</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"02\">02</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"03\">03</option>\r\n");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"mois_fin_cng\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"Janvier\">Janvier</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"Février\">Février</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"Mars\">Mars</option>\r\n");
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"année_fin_cng\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
for(int i=1930; i<=2060; i++){ 
      out.write("\r\n");
