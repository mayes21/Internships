...
public final class Sanction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form name=\"FormulaireSanction\" action=\"FormSanc.do\" method=\"post\" onSubmit=\"return verifformsnc()\">\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"annee_deb_sanc\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"annee_fin_sanc\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
for(int i=1930; i<=2060; i++){ 
      out.write("\r\n");
