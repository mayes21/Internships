...
public final class Conge_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form name=\"FormulaireConge\" action=\"FormCng.do\" method=\"post\" onSubmit=\"return verifformcng()\">\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t\t<td class=\"td2\"><select class=\"choix\" name=\"annee_cng\">\r\n");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"annee_deb_cng\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
for(int i=1930; i<=2060; i++){ 
      out.write("\r\n");
...
for(int i=10;i<=31;i++){ 
      ...
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"choix\" name=\"annee_fin_cng\">\r\n");
      out.write("\t\t\t\t\t\t<option selected></option>\r\n");
      out.write("\t\t\t\t\t\t");
for(int i=1930; i<=2060; i++){ 
      out.write("\r\n");
