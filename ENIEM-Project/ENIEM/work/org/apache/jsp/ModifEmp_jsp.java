...
public final class ModifEmp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script language=\"Javascript\" src=\"JavaScript/formAcc1.js\"></script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t\r\n");
    ...
    out.println("<center><form name=\"formulaireModif\" action=\"emploiModif.jsp\" method=\"post\" onSubmit=\"return verifAcc1()\">");
    ...
    out.println("<tr><center><font size=6><font style=\"font-family:'Trebuchet MS', Arial, Helvetica, sans-serif\">   " +
            "Liste des employés</font></center></tr>");
    ...
    while (rs.next())
        {
            ...
            out.println("<td width=\"5%\" align=\"center\" bgcolor=\"#A6C6D9\"><input type=\"radio\" name=\"idModif\" value=\""+id+"\"></td>");
    ...
    rs.close();
                    ...
                    out.println("<input type=\"submit\" name=\"modif\" value=\"Modifier\"/>");
                    out.println("</center");
                    out.println("</form>");
