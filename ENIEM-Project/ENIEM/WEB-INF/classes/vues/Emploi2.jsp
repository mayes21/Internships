...
<body>
	...
	<div style="margin-left:400px;margin-top:100px;">
		<div id="deco1" style="width:300px;height:120px;">
				<div style="position:absolute"><a class="buttConf" href="ModifEmp.jsp"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:9px;padding-left:25px;padding-right:76px;">Modifier un employé</p></a></div><br/><br/><br/>
				<div style="position:absolute"><a class="buttConf" href="emploiSuppr.jsp"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:9px;padding-left:25px;padding-right:57px;">Supprimer un employé</p></a></div>
		</div>
	</div>
