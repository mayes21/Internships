...
<body>
	...
	<div class="position">
  		<div id="en-tete">
			<ul class="ong1">
  				<li class="ong" id="actif"><span><b>Consultation</b></span></li>
  				<li class="ong"><a href="CONFIGURATION"><span><b>Configuration</b></span></a></li>
  				<li class="ong"><a href="deconnexionadm.do"><span><b>Déconnexion</b></span></a></li>
 			</ul>
 		 </div>
	</div>		
<CENTER>
	<div style="margin-top:40px;width:82%;">
