...
<body>
	...
	<div class="cadreLog">
		<form name="FormConnectAdmin" action="connexionperspaie.do" method="post">
			<table>
				<tr>
					<td><b>Login :</b></td>
					<td class="td"><input class="moz" type="text" name="login" size="40" value = "<%=((map.get("login1") != null) ? map.get("login1") : "") %>"></td>
				</tr>
				<tr></tr><tr></tr><tr></tr>
				<tr>
					<td><b>Password :</b></td>
					<td class="td"><input class="moz" type="password" name="password" size="40" value= "<%=((map.get("login1") != null) ? map.get("password1") : "") %>"></td>
				</tr>
				<tr></tr><tr></tr><tr></tr>
				<tr>
					<td><b>Connexion automatique :</b></td>
					<td style="text-align:left;padding-left:20px;"><input type="checkbox" name="auto_connect" value = "Y" <%=(((map.get("login1") != null) && (map.get("login1") != null)) ? "checked" : "") %>/></td>
				</tr>
				<tr></tr><tr></tr><tr></tr>
				<tr>
					<td></td>
