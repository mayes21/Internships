...
<body onLoad="noBack();" onpageshow="if(event.persisted)noBack();" onUnload="">
 ...
 <div style="margin-left:275px;position:absolute;margin-top:42px;">
		<table>
			<tr>
				<td style="border-top:502px solid silver;"></td>
			</tr>		
		</table>
	</div>
	...
	<div class="position2">
		<div id="deco1" style="width:320px;height:225px;">
				<div style="position:absolute"><a class="buttConf" href="FORMATION"><p style="color:white;background-image:url(CSS/images/buttConf.jpg);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:9px;padding-left:25px;padding-right:48px;">Formation longue durée</p></a></div><br/><br/>
				<div style="position:absolute"><a class="buttConf"><p style="color:white;background-image:url(CSS/images/buttConf.jpg);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:9px;padding-left:25px;padding-right:51px;">Formation courte durée</p></a></div>
		</div>
	</div>
	
	<div style="position:absolute; top:6px; left:150px;">
		<img src="CSS/images/logoEniem2.png" alt="logoEniem2">
	</div>
	
	<div class="position2">
		<div id="deco1" style="width:320px;height:225px;">
				<div style="position:absolute"><a class="buttConf"  href="FORMATION"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:48px;">Formation longue durée</p></a></div><br/><br/>
				<div style="position:absolute"><a class="buttConf"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:51px;">Formation courte durée</p></a></div>
		</div>
	</div>	
	...
	<div class="position">
  		<div id="en-tete">
			<ul class="ong1">
    			...
    			<li class="ong"><a href="deconnexionempform.do"><span><b>D&eacuteconnexion</b></span></a></li>
 			</ul>
  		</div>
	</div>	
