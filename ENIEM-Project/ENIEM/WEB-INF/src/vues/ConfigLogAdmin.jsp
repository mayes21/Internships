...
<title>Set Login Admin</title>
<script language="Javascript" src="JavaScript/formLogAdmin.js"> </script>
</head>
<body>
	...
	<div class="position4">
		<div id="deco1" style="width:320px;height:225px;">
				<div style="position:absolute"><a class="buttConf"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:68px;">Modifier Login Admin</p></a></div><br/><br/>
  				<div style="position:absolute"><a class="buttConf" href="CONFIGPASSADMIN"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:34px;">Modifier Password Admin</p></a></div> 			
 		</div>
	</div>
	...
	<div style="position:absolute;top:187px;left:430px;">
		<p style="color:grey;background-color:#DAE6E7;border:#C5DCE4 solid 3px;padding:2px 2px 2px 2px;font-family:Arial;font-size:24px;"><b>Modifier Login ADMIN</b></p>
	</div>
	
	<div class="cadre" style="margin-left:400px; margin-top:120px;width:440px;height:100px;">
	<form name="FormSetLog" action="logadm.do" method="post" onSubmit="return validation(this)">
		<table>
			<tr>
				<td class="td">Saisir le login actuel :</td>
				<td class="td2"><input class="moz" type="text" name="oldloginAdmin" size="30"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Saisir le nouveau login :</td>
				<td class="td2"><input class="moz" type="text" name="newloginAdmin" size="30"/></td>
			</tr>
		</table>
		<br/>
