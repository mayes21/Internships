...
<title>Mutation ajoutée avec succès</title>
</head>
<body>
	...
	<div class="cadrSucc" style="margin-left:400px;margin-top:190px;width:480px;heigh350px;">
		<div style="text-align:left; color:#36A753; font-weight:bold; font-size:18px;font-family:Arial;fond-size:14px;">
			Cette mutation a été ajoutée avec succès<span style="color:#C6E4BE;">_____</span> <img src="Images/succes.png" alt="succ">
			<br/>
		</div>
		<div style="text-align:left; color:black; font-weight:bold; font-size:16px;font-family:Arial;margin-top:20px;fond-size:14px;">
			...
			<span style="color:blue;">Nouveau département :</span><%= request.getParameter("nouv_dept").toString()%><br/><br/>
			<span style="color:blue;">Raison de la mutation :</span><%= request.getParameter("rai_mut").toString()%><br/><br/>
			<span style="color:blue;">Date de la mutation :</span><%= request.getParameter("jour_mut").toString()%>-<%= request.getParameter("mois_mut").toString()%>-<%= request.getParameter("annee_mut").toString()%><br/><br/>
		</div>
		<div style="position:absolute; top:560px; left:1080px;">
			<a href="MUTATION" title="Retour au formulaire d'ajout de promotion"><img src="Images/bouton-retour-accueil.png" alt="bouton-retour-accueil"></a>
		</div>
	</div>
