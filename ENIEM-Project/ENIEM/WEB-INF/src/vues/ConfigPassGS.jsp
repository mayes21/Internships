...
<title>Set Password GS</title>
<script language="Javascript" src="JavaScript/formPasswordGS.js"> </script>
</head>
<body>	
	...
	<div class="position4">
		<div id="deco1" style="width:320px;height:225px;">
				<div style="position:absolute"><a class="buttConf"  href="CONFIGLOGGS"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:92px;">Modifier Login GS</p></a></div><br/><br/>
  				<div style="position:absolute"><a class="buttConf"><p style="color:white;background-image:url(Images/buttConf.png);font-family:Arial;font-size:17px;padding-top:9px;padding-bottom:7px;padding-left:25px;padding-right:58px;">Modifier Password GS</p></a></div> 			
 		</div>
	</div>	
	
	<div style="position:absolute;top:187px;left:430px;">
		<p style="color:grey;background-color:#DAE6E7;border:#C5DCE4 solid 3px;padding:2px 2px 2px 2px;font-family:Arial;font-size:24px;"><b>Modifier Password GS</b></p>
	</div>
	
	<div class="cadre" style="margin-left:400px; margin-top:120px;width:480px;height:130px;">
	<form name="FormSetPass" action="passgs.do" method="post" onSubmit="return validation(this)">
		<table>
			<tr>
				<td class="td">Saisir le mot de passe actuel :</td>
				<td class="td2"><input class="moz" type="text" name="oldPassGS" size="20"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Saisir le nouveau mot de passe :</td>
				<td class="td2"><input class="moz" type="password" name="newPassGS" size="20"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Confirmer le nouveau mot de passe :</td>
				<td class="td2"><input class="moz" type="password" name="newPass1GS" size="20"/></td>
			</tr>
		</table>
		<br/>
