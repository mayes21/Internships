...
<script language="Javascript" src="JavaScript/formMutation.js"></script>
</head>
<body>
	...
	<div style="position:absolute;top:173px;left:430px;">
		<p style="color:grey;background-color:#DAE6E7;border:#C5DCE4 solid 3px;padding:2px 2px 2px 2px;font-family:Arial;font-size:24px;"><b>Ajouter une mutation</b></p>
	</div>
	
	<div class="cadre" style="margin-left:400px; margin-top:110px;width:600px;height:250px;">
	<form name="FormulaireMutation" action="FormMut.do" method="post" onSubmit="return verifformmut()">
		<table>
		<% 
			...
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Nouveau département : </td>
				<td class="td2"><input class="moz" type="text" name="nouv_dept" size="30" maxlength=20/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Raison de la mutation : </td>
				<td class="td2"><textarea class="moz" name="rai_mut" rows=1 cols=50 onkeypress="this.value=this.value.substr(0,50)"/></textarea></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Date de la mutation : </td>
				<td class="td2"><select class="choix" name="jour_mut">
					...
					<select class="choix" name="mois_mut">
								<option selected></option>
					...
					<select class="choix" name="annee_mut">
						<option selected></option>
