...
<script language="Javascript" src="JavaScript/formFormationCD.js"> </script>
</head>
<body>
	...
	<form name="FormFCD" action="FormCourte.do" method="post" onSubmit="return verifFCD()">
	<table>
	<% 
			...
			<tr>
				...
				<td class="td2"><input class="moz" type="text" name="int_fcd" size="20"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>	
			<tr>
				...
				<select class="choix" name="mois_deb_fcd">
								<option selected></option>
				...
				<select class="choix" name="annee_deb_fcd">
						<option selected></option>
			...
			<tr>
				...
				<td class="td2"><select class="choix" name="jour_fin_fcd">
								<option selected></option>
								<option value="01">01</option>
								<option value="02">02</option>
								<option value="03">03</option>
				...
				<select class="choix" name="mois_fin_fcd">
								<option selected></option>
								<option value="Janvier">Janvier</option>
								<option value="Février">Février</option>
								<option value="Mars">Mars</option>
				...
				<select class="choix" name="annee_fin_fcd">
						<option selected></option>
						<%for(int i=1930; i<=2060; i++){ %>
							<option value="<%=i %>"><%=i %></option>
						<%} %>			
			...
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Thème de la formation :</td>	
				<td class="td2"><input class="moz" type="text" name="theme_fcd" size="30"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="td">Durée de la formation :</td>	
				<td class="td2"><input class="moz" type="text" name="dur_fcd" size="10"/></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
		</table>
		<br/>
